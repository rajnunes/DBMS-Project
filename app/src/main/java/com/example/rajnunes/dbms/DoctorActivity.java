...
public class DoctorActivity extends AppCompatActivity {
    ...
    public EditText inputDesignation;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        inputDesignation= (EditText) findViewById(R.id.editDesignation);
    ...
    private void addPatient() {
        ...
        final String designation = inputDesignation.getText().toString().trim();
        ...
        class AddPatient extends AsyncTask<Void, Void, String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(DoctorActivity.this, "Adding...", "Wait...", false, false);
            }
            ...
            protected void onPostExecute(String s) {
                ...
                loading.dismiss();
                Toast.makeText(DoctorActivity.this, s, Toast.LENGTH_LONG).show();
            }
            ...
            protected String doInBackground(Void... v) {
                ...
                params.put(Config.KEY_EMP_DESIGNATION,designation);
                params.put(Config.KEY_EMP_GEN, gender);

                RequestHandler rh = new RequestHandler();
                String res = rh.sendPostRequest(Config.URL_ADD_DOC, params);
                return res;
            }
        }
