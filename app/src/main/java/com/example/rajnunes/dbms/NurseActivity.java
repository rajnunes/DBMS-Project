    ...
    private void addPatient() {
        ...
        class AddPatient extends AsyncTask<Void, Void, String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(NurseActivity.this, "Adding...", "Wait...", false, false);
            }
            ...
            protected void onPostExecute(String s) {
                ...
                loading.dismiss();
                Toast.makeText(NurseActivity.this, s, Toast.LENGTH_LONG).show();
            }
            ...
            protected String doInBackground(Void... v) {
                ...
                String res = rh.sendPostRequest(Config.URL_ADD_NURSE, params);
                return res;
            }
        }
